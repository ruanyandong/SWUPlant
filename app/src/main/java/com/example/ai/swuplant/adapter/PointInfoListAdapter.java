...
public class PointInfoListAdapter extends RecyclerView.Adapter<PointInfoListAdapter.ViewHolder>{
    ...
    public PointInfoListAdapter(Context context,List<PlantModel> list){
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.point_image);
            textView = itemView.findViewById(R.id.point_plant_name);
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.point_info_list_item,parent,false);
