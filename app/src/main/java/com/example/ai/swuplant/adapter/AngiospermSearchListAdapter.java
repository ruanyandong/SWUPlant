...
public class AngiospermSearchListAdapter extends RecyclerView.Adapter<AngiospermSearchListAdapter.ViewHolder>{
    ...
    public AngiospermSearchListAdapter(Context context, List<PlantModel> list){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.angiosperm_search_list_item,parent,false);
